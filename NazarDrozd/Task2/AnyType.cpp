...
bool AnyType::GetValueBool() const
{
	if (m_type != Type::BOOL)
	{
		throw ExceptionType("Access denied. Your type isn't 'bool'");
	}
	return m_value_bool;
}
short AnyType::GetValueShort() const
{
	...
	{
		throw ExceptionType("Access denied. Your type isn't 'short'");
	}
...
int AnyType::GetValueInt() const
{
	if (m_type != Type::INT)
	{
		throw ExceptionType("Access denied. Your type isn't 'int'");
	}
	return m_value_int;
}
long long AnyType::GetValueLongLong() const
{
	...
	{
		throw ExceptionType("Access denied. Your type isn't 'long long'");
	}
...
char AnyType::GetValueChar() const
{
	if (m_type != Type::CHAR)
	{
		throw ExceptionType("Access denied. Your type isn't 'char'");
	}
	return m_value_char;
}
float AnyType::GetValueFloat() const
{
	...
	{
		throw ExceptionType("Access denied. Your type isn't 'float'");
	}
...
double AnyType::GetValueDouble() const
{
	...
	{
		throw ExceptionType("Access denied. Your type isn't 'double'");
	}
...
long double AnyType::GetValueLongDouble() const
{
	...
	{
		throw ExceptionType("Access denied. Your type isn't 'long double'");
	}
